...
<script>
    ...
    function appendDocsDecoder() {
        setTimeout(function () {

            var x = document.createElement("A");
            var t = document.createTextNode("JWT Decoder for responses : https://jwt.io/");
            x.setAttribute("href", "https://jwt.io/");
            x.setAttribute("target", "_blank");
            x.setAttribute('class', 'jwtDecoder');
            x.appendChild(t);
            document.getElementsByClassName("main")[0].appendChild(x);
