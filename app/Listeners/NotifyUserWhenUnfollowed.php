...
class NotifyUserWhenUnfollowed extends KryptonianRedis
{
    /**
     ...
     * Handle the event.
     *
     * @param  NewUnfollowNotification  $event
     * @return void
     */
    public function handle(NewUnfollowNotification $event)
    {
    ...
    protected function notifyUser(User $user, User $follower, $channel) {
        ...
        $data = [
          ...
          'title' => 'unfollowed',
          'description' => ($follower->name ? $follower->name : $follower->username) . ' unfollowed you!',
          'type' => 'Unfollow',
          'task_id' => 0
        ];
